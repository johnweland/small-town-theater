  ...
  const formSections = (
    <div className="grid gap-8 xl:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)]">
      <div className="flex min-w-0 flex-col gap-8">
        <AdminMoviePrimarySections movie={movie} />
      </div>

      <div className="flex min-w-0 flex-col gap-8">
        <AdminMovieArtworkSection movie={movie} />
      </div>
    </div>
  );
...
export function AdminMoviePrimarySections({
  movie,
}: {
  movie: AdminMovieFormValue;
}) {
...
export function AdminMovieArtworkSection({
  movie,
}: {
  movie: AdminMovieFormValue;
}) {
...
export function AdminMovieWorkflowFooter() {
  return (
    <div className="flex flex-col gap-4 rounded-lg bg-surface-container-high p-5 sm:flex-row sm:items-center sm:justify-between">
      <div>
        <p className="font-sans text-sm font-semibold text-foreground">Movie workflow</p>
