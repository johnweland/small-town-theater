  ...
  return (
    <Toaster
      ...
      toastOptions={{
        ...
        classNames: {
          toast:
            "group relative flex w-[min(420px,calc(100vw-2rem))] items-center gap-5 overflow-hidden border border-border/15 bg-surface-container-low pl-0 pr-5 py-0 shadow-xl shadow-black/35 before:absolute before:inset-y-0 before:left-0 before:w-1 before:bg-primary",
          content: "flex min-w-0 flex-1 items-center gap-5 py-6 pr-2",
          ...
          closeButton:
            "absolute right-4 top-1/2 flex size-8 -translate-y-1/2 items-center justify-center rounded-full text-muted-foreground/70 transition-colors hover:bg-surface-container-high hover:text-foreground [&_svg]:size-4",
